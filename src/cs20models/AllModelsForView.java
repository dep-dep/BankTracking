 ...
 * 
 * A sample model class is provided in the form of the CardPerson.
...
public class AllModelsForView extends javax.swing.JFrame {
    ...
    public User aUser = new User();
    
    public UserLists theUserLists = new UserLists();
    
    public CardPerson aCardPerson = new CardPerson();
    
    public CardList theCardList = new CardList();
    
    public CardTransList theTransList = new CardTransList();
    
    public ExpensePerson theExpensePerson = new ExpensePerson();
    
//    public UserTranCardList theUserTranCardList = new UserTranCardList();
    
    public ExpenseList theExpenseList = new ExpenseList(); 
    
    public EncryptDecryption theEncrptDecrpt = new EncryptDecryption();
